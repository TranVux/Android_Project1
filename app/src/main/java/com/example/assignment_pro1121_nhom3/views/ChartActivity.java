...
public class ChartActivity extends AppCompatActivity {
        ...
        adapter = new ChartPlaylistAdapter(this, new ChartPlaylistAdapter.ItemChartEvent() {
            ...
            public void onItemClick(Music music, int position) {
                if (adapter.getItemCount() > 0) {
                    ...
                    saveCurrentMusic(KEY_TOP_10, KEY_TOP_10, musicPlayer.getCurrentIndexSong());
                    Log.d(TAG, "onClick: " + musicPlayer.getStateMusicPlayer());
                    startActivity(new Intent(ChartActivity.this, MainActivity.class));
                    startServiceMusic((ArrayList<Music>) adapter.getList(), MusicPlayer.MUSIC_PLAYER_ACTION_RESET_PLAYLIST, musicPlayer.getCurrentMode());
                }
            }
    ...
    public void saveCurrentMusic(String idPlaylist, String typePlaylist, int index) {
        ...
        editor.putInt(KEY_SONG_INDEX, index);
        editor.apply();
    }
